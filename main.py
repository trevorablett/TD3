...
if __name__ == "__main__":
	...
	parser.add_argument("--render", action="store_true")            # Render env on rollouts
	args = parser.parse_args()

	# discriminator interaction arguments  #todo make this a yaml or similar
	disc_int_args = dict(
		discrim_reward=True,
		allow_interventions=False,
		pre_train=True,
		expert_data_file="./expert_data/ThingReachingXYState.npy"
	)
	...
	# if disc_int_args['pre_train']:
	# 	policy.actor = behavior_clone(policy, )
	...
	for t in range(int(args.max_timesteps)):
		...
		if t >= args.start_timesteps:
			...
			# print('model update time: ', time.time() - model_update_start)
